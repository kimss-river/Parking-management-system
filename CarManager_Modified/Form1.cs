...
namespace CarManager_Modified
{
    ...
    {
        private string Psc(string psN)
        {
            string psS = "";

            switch (psN.Substring(0, 1))
            {
                case "1":
                    psS = "지상" + psN.Substring(1, 2) + "층 ";
                    break;
                case "2":
                    psS = "지하" + psN.Substring(1, 2) + "층 ";
                    break;
            }
            switch (psN.Substring(3, 1))
            {
                case "1":
                    psS += "A구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "2":
                    psS += "B구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "3":
                    psS += "C구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "4":
                    psS += "D구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "5":
                    psS += "E구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "6":
                    psS += "F구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "7":
                    psS += "G구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "8":
                    psS += "H구역" + psN.Substring(4, 2) + "번";
                    break;                
                case "9":
                    psS += "I구역" + psN.Substring(4, 2) + "번";
                    break;
            }
            return psS;
        }
        ...
        {
            InitializeComponent();
            textBox_parkingSpot.Text = Psc(DataManager.Cars[0].ParkingSpot.ToString());
        ...
        private void dataGridView_parkingManager_CurrentCellChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox_parkingSpot.Text = Psc(car.ParkingSpot.ToString());
